#ifndef _QSS_module_H__
#define __QSS_module_H__
...
class QSS_module : public Module
{
	struct projectile
	{
		int x, y;
	...
	{
		LOG("QSS PreUpdate keyBoard events!");
		...
		while (SDL_PollEvent(&event) != 0)
		{
			...
			else if (event.type == SDL_KEYDOWN)
			{
				...
				case SDLK_ESCAPE: return update_status::UPDATE_STOP; break;
